    ...
    variables: [
      {
        ...
        unidad: 'procesos', umbralVerde: 380, umbralRojo: 460,
      ...
      },
      {
        ...
        esConfiguracion: true, unidad: 'procesos',
      ...
      },
      {
        ...
        unidad: 'sesiones', umbralVerde: 240, umbralRojo: 285,
      ...
      },
      {
        ...
        unidad: 'sesiones', umbralVerde: 180, umbralRojo: 230,
      ...
      },
      {
        ...
        unidad: 'sesiones', umbralVerde: 150, umbralRojo: 220,
      ...
      },
      {
        ...
        unidad: 'sesiones', umbralVerde: 2, umbralRojo: 5,
      ...
      },
      {
        ...
        unidad: 'operaciones', umbralVerde: 3, umbralRojo: 8,
      ...
      },
      {
        ...
        fuente: 'V$RESOURCE_LIMIT', como: 'SQL',
        unidad: '%', umbralVerde: 70, umbralRojo: 90,
    ...
    variables: [
      {
        ...
        esConfiguracion: true, unidad: 'GB',
      ...
      },
      {
        ...
        unidad: '%', umbralVerde: 4, umbralRojo: 2,
      ...
      },
      {
        ...
        unidad: '%', umbralVerde: 99.5, umbralRojo: 99.95,
        justificacion: 'El Buffer Cache evita leer bloques de datos desde disco y Oracle lo mantiene lleno a propósito, por lo que una ocupación alta es lo normal. Solo cuando prácticamente no queda ningún buffer libre para reemplazo hay presión real de memoria; de ahí que los umbrales estén tan arriba.',
      },
      {
      ...
      },
      {
        ...
        unidad: '%', umbralVerde: 75, umbralRojo: 92,
      ...
      },
      {
        ...
        unidad: '%', umbralVerde: 85, umbralRojo: 98, penaliza: false,
      ...
      },
      {
        ...
        unidad: 'veces/día', umbralVerde: 1, umbralRojo: 3, penaliza: false,
      ...
      },
      {
        ...
        unidad: '%', umbralVerde: 90, umbralRojo: 75,
    ...
    variables: [
      {
        ...
        esConfiguracion: true, unidad: 'archivos',
      ...
      },
      {
        ...
        unidad: 'archivos', umbralVerde: 1, umbralRojo: 3,
      ...
      },
      {
        ...
        unidad: '%', umbralVerde: 80, umbralRojo: 95,
      ...
      },
      {
        ...
        unidad: '%', umbralVerde: 20, umbralRojo: 8,
      ...
      },
      {
        ...
        unidad: 'logs pendientes', umbralVerde: 2, umbralRojo: 5,
      ...
      },
      {
        ...
        unidad: 'archivos', umbralVerde: 1, umbralRojo: 2,
...
export function getPorcentajes(componenteId) {
  const pesos = getPesos(componenteId);
  return getPreferenciaPesos(componenteId).modo === MODO_PESOS_RELATIVOS
    ? porcentajesDesdeModo2(pesos)
    : pesos;
}

export function getFilasConPorcentaje(componenteId) {
  const componente = getComponente(componenteId);
  if (!componente) return [];

  const porcentajePorId = new Map(getPorcentajes(componenteId).map((p) => [p.id, p.valor]));
...
export function hidratarAjustes(componenteId, filas) {
  const componente = getComponente(componenteId);
  if (!componente) return null;
  ...
  for (const variable of componente.variables) {
    const fila = porCodigo.get(variable.id);
    if (!fila) continue;

    if (!variable.esConfiguracion) {
      variable.umbralVerde = fila.umbral_verde;
      variable.umbralRojo = fila.umbral_rojo;
    }
    if (fila.peso > 0) variable.peso = fila.peso;
  }
...
export function ajustesParaGuardar(componenteId) {
  const componente = getComponente(componenteId);
  if (!componente) return [];
  ...
  return componente.variables.map((variable) => ({
    codigo: variable.id,
    umbralVerde: variable.umbralVerde ?? null,
    umbralRojo: variable.umbralRojo ?? null,
    peso: porcentajePorId.get(variable.id) ?? variable.peso,
  }));
}
...
export function actualizarUmbrales(componenteId, variableId, umbralVerde, umbralRojo) {
  const variable = getVariable(componenteId, variableId);
  if (!variable) return null;
  variable.umbralVerde = umbralVerde;
  variable.umbralRojo = umbralRojo;
  return variable;
}
